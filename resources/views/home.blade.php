...
<header class="masthead text-white text-center" style="height: 46rem;">
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-6 col-10">
            <a class="_smilew navbar-brand mb-4" href="#"> <img class="img-fluid d-block" src="{{  asset('public/img/smilew-logo-darkblue.png')  }}"></a>
        </div>
    </div>
...
<script src="{{ asset('public/js/needed.js') }}"></script>
