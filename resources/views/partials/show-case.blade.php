...
<section class="showcase" id="comoFunciona">
    <div class="container-flui p-0">
        ...
        <div class="row no-gutters">
            <!-- DENTISTAS -->
            <div class="col-lg-6">
                <div class="showcase-img" style="background-image: url('{{asset('img/bg-showcase-22.jpg')}}');">
            ...
            <!-- PACIENTES -->
            <div class="col-lg-6" >
                <div class="showcase-img" style="background-image: url('{{asset('img/bg-showcase-13.jpg')}}');">
