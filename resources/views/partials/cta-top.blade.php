                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row justify-content-center">
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-7 my-5">
                                        <img class="img-fluid rounded-circle _shadow" src="{{asset('public/img/dentist-1.png')}}" alt="" style="border-radius: 10px;">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-10 my-auto _testimonial">
                                        ...
                                        <footer class="blockquote-footer text-light">Dr. Natanael Koubik</footer>
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-7 my-5">
                                        <img class="img-fluid rounded-circle _shadow" src="{{asset('public/img/pacient-2.png')}}" alt="" style="border-radius: 10px;">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-10 my-auto _testimonial _testimonial2">
